...
class UserFieldCollection implements ModelFieldsInterface
{
    ...
    public function fields()
    {
        return [
            ...
            // Password
            (new PasswordField('password'))->setTitle(trans('users::core.field.password')),
            (new PasswordField('password_confirmation'))->setTitle(trans('users::core.field.password_confirm')),
